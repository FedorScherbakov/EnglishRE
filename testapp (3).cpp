...
void TestApp::showResults() {
    ...
    QString resultText = QString(
        "<h2 style='margin-bottom: 10px;'>Test Completed, %1!</h2>"
        "<p style='margin: 5px 0;'>You answered <b>%2</b> out of <b>%3</b> questions correctly.</p>"
        "<p style='margin: 5px 0;'>Your English level is: <b>%4</b></p>"
        "<p style='margin: 5px 0 15px 0;'>%5</p>"
        "<h3 style='margin: 10px 0;'>Detailed Results:</h3>"
        "<div style='max-height: 200px; overflow-y: auto;'>"  // Ограничиваем высоту и добавляем прокрутку
        ...
        "<th style='padding: 3px; width: 30px;'>#</th>"
        "<th style='padding: 3px; min-width: 150px;'>Question</th>"
        "<th style='padding: 3px; width: 100px;'>Your Answer</th>"
        "<th style='padding: 3px; width: 100px;'>Correct Answer</th>"
        "<th style='padding: 3px; width: 80px;'>Result</th>"
        "</tr>"
        "</thead>"
        "<tbody>"
    ).arg(currentUsername)
